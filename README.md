...
4. **Origin Survivor:** Choose the survivor whose skin you are converting **from** (e.g., if converting from Ellis to Zoey, enter "ellis").
5. **Destination Survivor:** Enter the survivor you are converting **to** (e.g., "zoey").
